...
req.end();
      ...
      this.state.players[this.state.roboId].username =  names[ Math.floor(Math.random() * 3)];
      this.state.players[this.state.roboId].avatar =  avatars[ Math.floor(Math.random() * 3)];
